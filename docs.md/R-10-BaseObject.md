...
- `mul` _(Number)_
###### en ######
  - adjust the output _(lastout\[i\] = out\[i\] * mul + add)_
###### ja ######
  - 出力値を調整します。最終出力値は 出力値 * mul + add になります。
###### -- ######
...
###### en ######
  - returns `true` if receiver is an **audio rate**
###### ja ######
  - **オーディオレート**のとき `true` を返す
###### -- ######

- `isKr` _(ReadOnly Boolean)_
###### en ######
  - returns `true` if receiver is a **control rate**
###### ja ######
  - **コントロールレート**のとき `true` を返す
###### -- ######
