...
###### en ######
  - Returns `true` if the receiver should start over again when finished.
###### ja ######
  - ループ再生するとき true を返す
###### -- ######
...
###### en ######
  - Returns `true` if the receiver should play in reverse.
###### ja ######
  - 逆再生するとき true を返す
###### -- ######  
...
###### en ######
  - Returns `true` if the playback of the receiver has ended.
###### ja ######
  - 再生終了時に true になる
###### -- ######  
...
- `clone()`
###### en ######
  - Returns a clone that share a buffer with an origin object.
###### ja ######
...
- `slice(begin, end)`
###### en ######
  - Returns a slice copied object between begin and end(milliseconds).
###### ja ######
