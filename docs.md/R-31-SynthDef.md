...
## Description ##
###### en ######
`T("SynthDef")` manages a **SynthDef** with `noteOn`, `noteOff`.
###### ja ######
...
- `def` _(Function)_
###### en ######
  - A **SynthDef** function that should return **T-Object**.
###### ja ######
...
- `poly` _(Number)_
###### en ######
  - The maximum number of polyphony. Its default value is **4**, with a range between 1 to 64.
###### ja ######  
...
- `opts.noteNum`
###### en ######
  - The MIDI number of `noteOn()` or `noteOff()` with a range between 0 to 127.
###### ja ######
...
- `opts.freq`
###### en ######
  - The frequency of `noteOn()` or `noteOff()`.
###### ja ######
  - noteOn された 音の周波数
###### -- ######
...
- `opts.velocity`
###### en ######
  - The velocity of `noteOn()` with a range between 0 to 127.
###### ja ######
...
- ohters
###### en ######
  - The 3rd argument of `noteOn()` or `noteOff()`.
###### ja ######
  - noteOn の第3引数で指定した値
###### -- ######  
...
###### en ######
  - Send `release()` to **T-Object** that managed with a MIDI note number.
###### ja ######
...
- `allNoteOff()`
###### en ######
  - Send `noteOff()` to all **T-Object** that manged by `noteOn()` or `noteOnWithFreq()`.
###### ja ######
  - すべての音にノートオフする
###### -- ######
